...
- **Update the codebase proactively.** When the next move is obvious, just edit the file. Ask only when the change requires user's judgment. The codebase is yours to maintain.  
