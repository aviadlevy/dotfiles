...
command -v brew >/dev/null 2>&1 || \
	(echo '    Adding Homebrew to source' && echo 'eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"') >> /root/.bashrc && eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)" && source ~/.bashrc)
